...
def arg_parser():
	...
	parser.add_argument('--seed', metavar = 'SE', type = int, default = 1410, help = 'random seed number for inference, reproducibility')
	parser.add_argument('-n', '--n_customer', metavar = 'N', type = int, default = 50, help = 'number of customer nodes, time sequence') # TODO: when train a new-customer model, node is changed here

	# train config
	parser.add_argument('-b', '--batch', metavar = 'B', type = int, default = 128, help = 'batch size')
	parser.add_argument('-bs', '--batch_steps', metavar = 'BS', type = int, default = 150, help = 'number of samples = batch * batch_steps')
	...
	parser.add_argument('--lr', metavar = 'LR', type = float, default = 1.1e-4, help = 'initial learning rate')
	parser.add_argument('-wb', '--warmup_beta', metavar = 'WB', type = float, default = 0.7, help = 'exponential moving average, warmup')
	...
	parser.add_argument('-cd', '--cuda_dv', metavar = 'CD', type = str, default = '1,2', help = 'os CUDA_VISIBLE_DEVICE')
...
def train_parser():
	...
	parser.add_argument('-p', '--path', metavar = 'P', type = str, 
						default = 'Pkl/VRP50_train.pkl', #TODO: change node here
...
def test_parser():
	...
	parser.add_argument('-n', '--n_customer', metavar = 'N', type = int, default = 100, help = 'number of customer nodes, time sequence')
